...
description: Use PROACTIVELY after any UI/ERB change to audit it. Rewrites hand-written markup to use Keystone UI helpers and strips freehand Tailwind that overrides the components.
