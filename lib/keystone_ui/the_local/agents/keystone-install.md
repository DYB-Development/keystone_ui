...
description: Use to install or update Keystone UI in this app: run the install generator, bundle update keystone_ui, re-sync the CLAUDE.md reference, and report what changed.
