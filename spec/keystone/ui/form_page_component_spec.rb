...
RSpec.describe Keystone::Ui::FormPageComponent do
  it "exposes title" do
    component = described_class.new(title: "New Invoice", back_url: "/invoices")

    expect(component.instance_variable_get(:@title)).to eq("New Invoice")
  end
  ...
  it "returns true for subtitle? when subtitle is provided" do
    component = described_class.new(title: "New Invoice", back_url: "/invoices", subtitle: "Fill in the details")
